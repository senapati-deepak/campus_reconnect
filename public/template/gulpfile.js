...
gulp.task('injectAssets', function () {
  return gulp.src('./**/*.html')
    .pipe(inject(gulp.src(['./node_modules/font-awesome/css/font-awesome.min.css', './node_modules/mdi/css/materialdesignicons.css', './node_modules/perfect-scrollbar/dist/css/perfect-scrollbar.min.css' , './node_modules/jquery/dist/jquery.min.js', './node_modules/popper.js/dist/umd/popper.min.js' , './node_modules/bootstrap/dist/js/bootstrap.min.js' , './node_modules/perfect-scrollbar/dist/js/perfect-scrollbar.jquery.min.js'], {read: false}), {name: 'plugins', relative: true}))
    .pipe(inject(gulp.src(['./css/*.css' , './js/off-canvas.js' , './js/sidebar-icon.js' , './js/hoverable-collapse.js' , './js/misc.js'], {read: false}), {relative: true}))
    .pipe(gulp.dest('.'));
});
